package com.gabriel.scavassa.marvelapi.util;
...
public class AddContentToDatabase {

    static public void addContent(CharacterRepository characterRepository, ComicRepository comicRepository, UrlRepository urlRepository, ImageRepository imageRepository, ComicSumaryRepository comicSumaryRepository, TextObjectsRepository textObjectsRepository, ComicDateRepository comicDateRepository, ComicPriceRepository comicPriceRepository, StoriesRepository storiesRepository, EventSumaryRepository eventSumaryRepository, EventRepository eventRepository, SeriesRepository seriesRepository, CreatorsRepository creatorsRepository) {
        ...
        com.gabriel.scavassa.marvelapi.domain.Character hulk = new Character(null, "Hulk", "Green", LocalDate.now(), "Https://Hulk", urlArray, thumbnail, hulkComicList, hulkStoriesList, hulkEventList, hulkSeeriesList);
